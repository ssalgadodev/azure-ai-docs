...
Before you configure your experiment, upload your data file to your workspace in the form of an Azure Machine Learning dataset. Doing so, allows you to ensure that your data is formatted appropriately for your experiment.
    ...
    1. On the **Basic info** form, give your dataset a name and provide an optional description.
    
    1. On the **Task type & data** form, select **Classification** for **Select task type**. Then select **+ Create** to create a new data asset. 
    1. Enter a data asset name and select **mltable** as the data type
    1. Select a source to upload the data from. This can be uploaded from a URI, existing storage, or a file from your local drive. Select **From Local Files**.
    
    1. Select **Next** on the bottom left

    1. On the **Destination storage type** form, select the default datastore that was automatically set up during your workspace creation, **workspaceblobstore (Azure Blob Storage)**. This is the storage location where you upload your data file. 
    ...
    1. The **Task settings** form allows for further configuration of your data for this experiment. 
    
        1. For this example, select **cnt** as your target column. 
